...
- [-] ~~Pi~~ - **Marked as won't do** (Look at `bait`)
...
- [X] New Distro
    - [X] Migrate from NixOS to ~~Fedora~~ **Void Linux**  - I am currently using NixOS on my personal 
       ...
       like most about Nix, which is how it is very declarative.
    - [X] Kitty -> Ghostty
    - [X] Zen browser -> Helium
...
- [X] Neovim
    - [X] Clean up my Neovim upgrading to 0.12 - Neovim 0.12 is out and looks really
...
- [ ] `bait` custom agent harness
- [ ] `termtrix` Terminal centric Grafana alternative project
- [ ] `evalt` AI eval CLI
- [ ] `shapley`
    - [X] Landing page
    - [ ] Image uploading
    - [ ] Start Frontend
- [ ] Custom notes solution (Obsidian style notes, self hosted arch, Kanban
